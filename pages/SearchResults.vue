      ...
      <div class="container">
        ...
        <div class="container">
              <div class="top-block active-grid">
                <div
                  class="row d-flex justify-content-center text-align-center"
                >
                  <ResultCard
                    class="col-md-4"
...
export default defineComponent({
  ...
  computed: {
    ...mapGetters("drupalcms", ["getHomeLatest", "getShortArray"]),
  },
  methods: {
    ...mapActions("drupalcms", ["fetchHomeLatest"]),
  },
  mounted() {
